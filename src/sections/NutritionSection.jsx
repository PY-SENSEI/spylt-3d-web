      ...
      >
        <div className="relative inline-block md:translate-y-20">
          ...
          >
            ...
            <div style={{
              clipPath: "polygon(0% 0%, 0% 0%, 100% 0%, 0% 100%)"
        ...
        <div className="flex md:justify-center item translate-y-5">
            ...
            {lists.map((nutrient, index) => (
              <div key={index} className="relative flex-1 col-center">
                <div className="">
                  ...
                  <p className="fon-paragraph text-sm mt-2">up to</p>
                  <p className="text-2xl md:text-4xl tracking-tighte font-bold">
                    {nutrient.amount}
                  </p>
                </div>
